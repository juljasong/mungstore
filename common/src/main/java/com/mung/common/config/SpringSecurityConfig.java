package com.mung.common.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.mung.common.config.auth.PrincipalDetailsService;
import com.mung.common.config.jwt.JwtAuthenticationFilter;
import com.mung.common.config.jwt.JwtAuthorizationFilter;
import com.mung.common.config.handler.Http401Handler;
import com.mung.common.config.handler.Http403Handler;
import com.mung.common.config.jwt.JwtConfig;
...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http    .csrf(AbstractHttpConfigurer::disable)
                ...
                .addFilter(new JwtAuthorizationFilter(authenticationManager(), loginRepository, jwtConfig))
